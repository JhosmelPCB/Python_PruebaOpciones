...
# print(lista)
#----------------------------------------------------------------------------------------------------------------------
#profesor = "Alvaro Chirou"
#Para mostrar segun la posicion
#print(profesor[2:5])
...
#print(profesor[2:])
#print(profesor[:5])
#print(profesor[2:5] + profesor[1:4])


#Listas
#listas = [5,9,"Jhosmel", -8, "Estudiantes"]
#listas1 = [1,2,3,4,8,6,7,8,9]
#Correccion de Intervalo mediante caracteres
#listas1[4]= 5
#print(listas1)

#Adheriendo valor en cadena
#listas1.append(10)
#print(listas1)
#listas1.append(10+1)
#print(listas1)
...
#Union de Listas
#primera_lista = [10,20,30]
#segunda_lista = [40,50,60]
#tercera_lista = [70,80,90]
#cuarta_lista = [100, 110, 120]
#listas_anidadas = [primera_lista, segunda_lista, tercera_lista, cuarta_lista]
#print(listas_anidadas)

#Leer datos por teclado
#ENTEROS
#dato = input("Escriba su nombre ")
#print(dato)
#Converta la cadenas a entero
#dato = int(dato)
#print(dato + 5)
...
#dato = input("Escriba su nombre ")
#print(dato)
#Converta la cadenas a flotante
#dato = float(dato)
#print(dato + 5)
...
#abecedario= "Jhosmel"
#print(len(numeros1) + len(abecedario))
#len muestra la cantidad que se tiene en caracter
...
#jhosmel = 10
#if jhosmel == 10:
#    print('Jhosmel equivale a 45')
#if jhosmel == 10:
#    print('Jhosmel equivale a 10')
...
#else: 
#    print("Debes matricularte en mi curso")
...
#    print("interacion = ", iteracion)
#else:
#    print("No se pudo aplicar las iteraciones")
...
print("/tPython")
inicio = input("¿Desea empezar con el programa escriba S/N?: ")
...
while(inicio == 'S'):
    ...
    if opcion == 1:
        ...
        print("Gracias por usar el programa " + name)
        break
